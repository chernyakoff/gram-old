<template>
            ...
            <div class="w-full mb-4">
                <div class="flex items-center justify-between mb-1.5">
                    ...
                    <div class="flex items-center gap-1 relative">
                        ...
                        <UButton icon="bx:cube-alt" color="neutral" variant="subtle" @click="doSynonimize" v-if="!disableSynonimize" />
                    </div>
                </div>
    ...
    <BlockingModal title="Рандомизирую" text="Дождитесь окончания рандомизации" :open="isRandomizing" />
</template>
