...
from telethon.errors import TimeoutError as TelegramTimeout
...
from app.accounts.model import Account, AccountFile, AccountIn
from app.client import hatchet
from app.common.models import orm
from app.common.utils.functions import clear_dir, pick
from app.common.utils.s3 import AsyncS3Client
from app.proxies.pool import ProxyPool
from app.proxies.utils import get_user_proxies
...
async def save_account(
    ...
    try:
        async with pool.proxy(account.country, timeout=30) as proxy:
            ...
            except (RPCError, FloodWaitError, TelegramTimeout, OSError) as e:
                await logger.error(f"{account.phone} {e}")
